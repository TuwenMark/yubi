...
export async function genChartByAiUsingPOST(
  ...
  return request<API.BaseResponseGenChartVO_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiAsyncUsingPOST(
  ...
  return request<API.BaseResponseGenChartVO_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiAsyncMqUsingPOST(
  ...
  return request<API.BaseResponseGenChartVO_>('/api/chart/gen/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
